...
module CustomAttributes_Basic =
                   ...
                   [runtime]System.Collections.IStructuralComparable
  {
    ...
    let ``E_StructLayout_Extended_fs`` compilation =
        ...
        |> verifyCompile
        |> shouldFail
        |> withSingleDiagnostic (Error 3888, Line 7, Col 6, Line 7, Col 36, "LayoutKind value 1 (Extended) cannot be specified via StructLayoutAttribute. Use ExtendedLayoutAttribute instead.")
